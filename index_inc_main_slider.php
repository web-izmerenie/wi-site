...
<div id="general-cards" class="general-cards">
	<div class="backgrounds">
	...
	<div class="cards">
				...
				<div class="text">
					...
					<div class="description">
						<p>
							...
							наглядно показывающие концепцию и структуру
							будущего сайта.
						</p>
					</div>
				</div>
		...
		<section id="card-n2" data-card-num='2' class="card card-n2">
			<div class="wrap"><img src="<?=$tpPath?>/static/images/cards/slide2.png">
				<div class="text">
					...
					<div class="description">
						<p>
							Решения, принимаемые человеком на 100% эмоциональны.
							Доводы разума служат лишь оправданием уже сделанного
							выбора.<br>
							Поэтому мы уделяем особое внимание сильной визуальной
		...
		<section id="card-n4" data-card-num='4' class="card card-n4">
			<div class="wrap"><img src="<?=$tpPath?>/static/images/cards/slide4.png">
				<div class="text">
					...
					<div class="description">
						<p>
							Адаптивная верстка наших решений совместима с широким
		...
		<section id="card-n5" data-card-num='5' class="card card-n5">
			<div class="wrap"><img src="<?=$tpPath?>/static/images/cards/slide5.png">
				<div class="text">
					<h2><span class="num">5</span><span class="title">Развиваем и продвигаем</span></h2>
					<div class="description">
						<p>
